...
class LeNet9(BaseModel):
    ...
    def __init__(self, input_dim: tuple[int], num_classes: int) -> None:
        ...
        self.conv_block1 = BasicBlock(in_channels, 8)
        self.conv_block2 = BasicBlock(8, 16)
        self.conv_block3 = BasicBlock(16, 32)
        self.conv_block4 = BasicBlock(32, 32)
        self.conv_block5 = BasicBlock(32, 64)
        self.conv_block6 = BasicBlock(64, 128)
        ...
        self.fc1 = nn.Sequential(nn.Linear(fc_input_size, 1600), nn.ReLU())
        self.fc2 = nn.Sequential(nn.Linear(1600, 800), nn.ReLU())
        self.fc3 = nn.Sequential(nn.Linear(800, 100), nn.ReLU())
