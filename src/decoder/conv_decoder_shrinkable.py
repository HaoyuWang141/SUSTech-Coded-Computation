...
class CatChannelConvDecoder(Decoder):
    def __init__(
        self, num_in: int, num_out: int, in_dim: tuple, intermediate_channels=20, num_shrink=0
    ):
        ...
        self.nn = nn.Sequential(
            nn.Conv2d(
                ...
                kernel_size=3,
                stride=1,
                padding=1 if num_shrink <= 0 else 0,
                dilation=1,
            ),
            nn.ReLU(),
            nn.Conv2d(
                ...
                kernel_size=3,
                stride=1,
                padding=1 if num_shrink <= 1 else 0,
                dilation=1,
            ),
            nn.ReLU(),
            nn.Conv2d(
                ...
                kernel_size=3,
                stride=1,
                padding=2 if num_shrink <= 2 else 1,
                dilation=2,
            ),
            nn.ReLU(),
            nn.Conv2d(
                ...
                kernel_size=3,
                stride=1,
                padding=4 if num_shrink <= 3 else 2,
                dilation=4,
            ),
            nn.ReLU(),
            nn.Conv2d(
                ...
                kernel_size=3,
                stride=1,
                padding=8 if num_shrink <= 4 else 4,
                dilation=8,
            ),
            nn.ReLU(),
            nn.Conv2d(
